...
const EditFreelancers = () => {
  ...
  const {response: freelancerData, isLoading: isLoadingData} = useFetch('freelancers/:id', { id: id })
  const { response, isLoading: isLoadingUpdate, error, send: updateFreelancer } = useFetch('freelancers/:id', { id: id, immediate: false }, { method: 'post' })
  ...
  return (
    <Spin spinning={isLoadingData || isLoadingUpdate}>
      <Form
        name="basic"
        form={form}
        initialValues={{
